...
/* MBEDTLS_PSA_CRYPTO_KEY_EXTENDED_ID
 *
 * Enable key extended identifiers that encode key owner.
 *
 ...
 * from psa_key_extended_id_t to file name in all the storage backends that
 * you wish to support.
 *
 * Note that this option is meant for internal use only and may be removed
 * without notice.
 */
//#define MBEDTLS_PSA_CRYPTO_KEY_EXTENDED_ID
