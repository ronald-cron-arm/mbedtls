 ...
 */
static psa_status_t mbedtls_psa_cipher_encrypt_setup(
 ...
 * \retval #PSA_ERROR_CORRUPTION_DETECTED
 */
static psa_status_t mbedtls_psa_cipher_decrypt_setup(
    mbedtls_psa_cipher_operation_t *operation,
    const psa_key_attributes_t *attributes,
    const uint8_t *key_buffer, size_t key_buffer_size,
    psa_algorithm_t alg );
 ...
 * \retval #PSA_ERROR_INSUFFICIENT_MEMORY
 */
static psa_status_t mbedtls_psa_cipher_set_iv(
    mbedtls_psa_cipher_operation_t *operation,
 ...
 * \retval #PSA_ERROR_INSUFFICIENT_MEMORY
 */
static psa_status_t mbedtls_psa_cipher_update(
    mbedtls_psa_cipher_operation_t *operation,
 ...
 * \retval #PSA_ERROR_INSUFFICIENT_MEMORY
 */
static psa_status_t mbedtls_psa_cipher_finish(
    mbedtls_psa_cipher_operation_t *operation,
    uint8_t *output, size_t output_size, size_t *output_length );
 ...
 * \retval #PSA_SUCCESS
 */
static psa_status_t mbedtls_psa_cipher_abort( mbedtls_psa_cipher_operation_t *operation );
 ...
 *         padding, and the ciphertext does not contain valid padding.
 */
static psa_status_t mbedtls_psa_cipher_encrypt( const psa_key_attributes_t *attributes,
 ...
 *         padding, and the ciphertext does not contain valid padding.
 */
static psa_status_t mbedtls_psa_cipher_decrypt( const psa_key_attributes_t *attributes,
                                         const uint8_t *key_buffer,
                                         size_t key_buffer_size,
                                         psa_algorithm_t alg,
                                         const uint8_t *input,
