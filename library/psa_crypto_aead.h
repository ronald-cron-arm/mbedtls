 ...
 */
static psa_status_t mbedtls_psa_aead_encrypt(
 ...
 * \retval #PSA_ERROR_CORRUPTION_DETECTED
 */
static psa_status_t mbedtls_psa_aead_decrypt(
    const psa_key_attributes_t *attributes,
    const uint8_t *key_buffer, size_t key_buffer_size,
    psa_algorithm_t alg,
    const uint8_t *nonce, size_t nonce_length,
 ...
 */
static psa_status_t mbedtls_psa_aead_encrypt_setup(
 ...
 *         Failed to allocate memory for key material
 */
static psa_status_t mbedtls_psa_aead_decrypt_setup(
    mbedtls_psa_aead_operation_t *operation,
    const psa_key_attributes_t *attributes,
    const uint8_t *key_buffer,
    size_t key_buffer_size,
 ...
 *         the library.
 */
static psa_status_t mbedtls_psa_aead_set_nonce(
    mbedtls_psa_aead_operation_t *operation,
    const uint8_t *nonce,
    size_t nonce_length );
 ...
 *         the library.
 */
static psa_status_t mbedtls_psa_aead_set_lengths(
    mbedtls_psa_aead_operation_t *operation,
    size_t ad_length,
 ...
 *         the library.
 */
static psa_status_t mbedtls_psa_aead_update_ad(
    mbedtls_psa_aead_operation_t *operation,
    const uint8_t *input,
    size_t input_length );
 ...
 */
static psa_status_t mbedtls_psa_aead_update(
    mbedtls_psa_aead_operation_t *operation,
    const uint8_t *input,
    size_t input_length,
    uint8_t *output,
 ...
 *         buffer size.
 */
static psa_status_t mbedtls_psa_aead_finish(
    mbedtls_psa_aead_operation_t *operation,
    uint8_t *ciphertext,
 ...
 *         Success.
 */
static psa_status_t mbedtls_psa_aead_abort(
    mbedtls_psa_aead_operation_t *operation );
