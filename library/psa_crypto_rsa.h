 ...
 *                          when done.
 */
static psa_status_t mbedtls_psa_rsa_load_representation( psa_key_type_t type,
                                                  const uint8_t *data,
                                                  size_t data_length,
 ...
 * \retval #PSA_ERROR_INSUFFICIENT_MEMORY
 */
static psa_status_t mbedtls_psa_rsa_export_public_key(
    const psa_key_attributes_t *attributes,
 ...
 */
static psa_status_t mbedtls_psa_rsa_generate_key(
    const psa_key_attributes_t *attributes,
 ...
 */
static psa_status_t mbedtls_psa_rsa_sign_hash(
    const psa_key_attributes_t *attributes,
    const uint8_t *key_buffer, size_t key_buffer_size,
 ...
 * \retval #PSA_ERROR_INSUFFICIENT_MEMORY
 */
static psa_status_t mbedtls_psa_rsa_verify_hash(
    const psa_key_attributes_t *attributes,
    const uint8_t *key_buffer, size_t key_buffer_size,
    psa_algorithm_t alg, const uint8_t *hash, size_t hash_length,
 ...
 */
static psa_status_t mbedtls_psa_asymmetric_encrypt( const psa_key_attributes_t *attributes,
 ...
 *         results in this error code.
 */
static psa_status_t mbedtls_psa_asymmetric_decrypt( const psa_key_attributes_t *attributes,
                                             const uint8_t *key_buffer,
                                             size_t key_buffer_size,
                                             psa_algorithm_t alg,
                                             const uint8_t *input,
