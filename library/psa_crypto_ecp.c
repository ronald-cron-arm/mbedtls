...
psa_status_t psa_crypto_ecp_load_representation(
    ...
    size_t *key_buffer_length, size_t *bits )
{
    ...
    /* Parse input */
    status = psa_crypto_ecp_load_representation( attributes->core.type,
                                                 data,
                                                 data_length,
                                                 &ecp );
    if( status != PSA_SUCCESS )
     ...
     * copy operation. */
    status = psa_crypto_ecp_export_key( attributes->core.type,
                                        ecp,
                                        key_buffer,
                                        key_buffer_size,
                                        key_buffer_length );
...
psa_status_t psa_crypto_ecp_export_key( psa_key_type_t type,
    ...
    uint8_t *data, size_t data_size, size_t *data_length )
{
    ...
    status = psa_crypto_ecp_export_key(
    ...
    uint8_t *key_buffer, size_t key_buffer_size, size_t *key_buffer_length )
{
    ...
    mbedtls_ecp_group_id grp_id =
         mbedtls_ecc_group_of_psa( curve,
             PSA_BITS_TO_BYTES( attributes->core.bits ) );
...
/****************************************************************/
    ...
    defined(MBEDTLS_PSA_BUILTIN_ALG_DETERMINISTIC_ECDSA)
psa_status_t psa_crypto_ecdsa_sign_hash(
    const psa_key_attributes_t *attributes,
    const uint8_t *key_buffer, size_t key_buffer_size,
...
psa_status_t psa_crypto_ecdsa_verify_hash(
    const psa_key_attributes_t *attributes,
    const uint8_t *key_buffer, size_t key_buffer_size,
    psa_algorithm_t alg, const uint8_t *hash, size_t hash_length,
...
psa_status_t psa_crypto_ecp_import_key(
    const psa_key_attributes_t *attributes,
    const uint8_t *data, size_t data_length,
    uint8_t *key_buffer, size_t key_buffer_size,
    size_t *key_buffer_length, size_t *bits )
...
psa_status_t psa_crypto_ecp_export_public_key(
    const psa_key_attributes_t *attributes,
    const uint8_t *key_buffer, size_t key_buffer_size,
    uint8_t *data, size_t data_size, size_t *data_length )
{
...
#if defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_ECC_KEY_PAIR)
psa_status_t psa_crypto_ecp_generate_key(
    const psa_key_attributes_t *attributes,
    uint8_t *key_buffer, size_t key_buffer_size, size_t *key_buffer_length )
{
