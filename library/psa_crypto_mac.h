 ...
 */
static psa_status_t mbedtls_psa_mac_compute(
 ...
 */
static psa_status_t mbedtls_psa_mac_sign_setup(
 ...
 *         The operation state is not valid (it must be inactive).
 */
static psa_status_t mbedtls_psa_mac_verify_setup(
    mbedtls_psa_mac_operation_t *operation,
    const psa_key_attributes_t *attributes,
    const uint8_t *key_buffer,
    size_t key_buffer_size,
 ...
 * \retval #PSA_ERROR_CORRUPTION_DETECTED
 */
static psa_status_t mbedtls_psa_mac_update(
    mbedtls_psa_mac_operation_t *operation,
    const uint8_t *input,
    size_t input_length );
 ...
 * \retval #PSA_ERROR_CORRUPTION_DETECTED
 */
static psa_status_t mbedtls_psa_mac_sign_finish(
    mbedtls_psa_mac_operation_t *operation,
    uint8_t *mac,
    size_t mac_size,
    size_t *mac_length );
 ...
 * \retval #PSA_ERROR_CORRUPTION_DETECTED
 */
static psa_status_t mbedtls_psa_mac_verify_finish(
    mbedtls_psa_mac_operation_t *operation,
    const uint8_t *mac,
    size_t mac_length );
 ...
 * \retval #PSA_ERROR_CORRUPTION_DETECTED
 */
static psa_status_t mbedtls_psa_mac_abort(
    mbedtls_psa_mac_operation_t *operation );
