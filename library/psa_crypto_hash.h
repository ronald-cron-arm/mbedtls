 ...
 */
static psa_status_t mbedtls_psa_hash_compute(
    psa_algorithm_t alg,
    const uint8_t *input,
    size_t input_length,
    uint8_t *hash,
 ...
 * \retval #PSA_ERROR_CORRUPTION_DETECTED
 */
static psa_status_t mbedtls_psa_hash_setup(
 ...
 * \retval #PSA_ERROR_INSUFFICIENT_MEMORY
 */
static psa_status_t mbedtls_psa_hash_clone(
 ...
 * \retval #PSA_ERROR_CORRUPTION_DETECTED
 */
static psa_status_t mbedtls_psa_hash_update(
    mbedtls_psa_hash_operation_t *operation,
    const uint8_t *input,
    size_t input_length );
 ...
 * \retval #PSA_ERROR_CORRUPTION_DETECTED
 */
static psa_status_t mbedtls_psa_hash_finish(
    mbedtls_psa_hash_operation_t *operation,
    uint8_t *hash,
    size_t hash_size,
    size_t *hash_length );
 ...
 * \retval #PSA_ERROR_CORRUPTION_DETECTED
 */
static psa_status_t mbedtls_psa_hash_abort(
    mbedtls_psa_hash_operation_t *operation );
