 ...
 */
static psa_status_t psa_crypto_rsa_export_key( psa_key_type_t type,
                                        ...
                                        size_t data_length )
{
    ...
    status = psa_crypto_rsa_export_key( slot->attr.type,
                                        rsa,
                                        output,
                                        data_length,
                                        &data_length);
 ...
 * \param[out] data_length  The amount of bytes written to \p data
 */
static psa_status_t psa_crypto_ecp_export_key( psa_key_type_t type,
                                        ...
                                        size_t data_length )
{
    ...
    status = psa_crypto_ecp_export_key( slot->attr.type,
                                        ecp,
                                        output,
                                        data_length,
                                        &data_length);
                                             ...
                                             int export_public_key )
{
    ...
    *data_length = 0;
    ...
    defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_RSA_PUBLIC_KEY)
            ...
            status = psa_crypto_rsa_export_key( PSA_KEY_TYPE_RSA_PUBLIC_KEY,
                                                rsa,
                                                data,
                                                data_size,
                                                data_length );
    ...
    defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_ECC_PUBLIC_KEY)
            ...
            status = psa_crypto_ecp_export_key(
                PSA_KEY_TYPE_ECC_PUBLIC_KEY(
                    PSA_KEY_TYPE_ECC_GET_FAMILY( slot->attr.type ) ), ecp,
                data, data_size, data_length );
    ...
    const uint8_t *domain_parameters, size_t domain_parameters_size )
{
    ...
    if ( type == PSA_KEY_TYPE_RSA_KEY_PAIR )
    {
        ...
        status = psa_crypto_rsa_export_key( type,
                                            &rsa,
                                            slot->key.data,
                                            bytes,
                                            &slot->key.bytes );
