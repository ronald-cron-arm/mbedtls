...
component_build_arm_none_eabi_gcc_arm5vte () {
    ...
    # component_build_arm_none_eabi_gcc_arm5vte
    # in case the arm-linux-gnueabihf toolchain is not available
    make CC="${ARM_NONE_EABI_GCC_PREFIX}gcc" AR="${ARM_NONE_EABI_GCC_PREFIX}ar" CFLAGS='-Werror -Wall -Wextra -march=armv5te -O1' LDFLAGS='-march=armv5te' lib
